<template>
    <div>
        ...
        <div class="container-evento">
            <span class="container-evento__title">Pago de propuestas</span>
        </div>
                    ...
                    <div class="box-resumen">
                        ...
                        <div class="box-resumen__body">
                            ...
                            <div class="box-resumen__precios">
                                ...
                                <div class="wt-space-block wt-m-bot-1">
                                    <span>Total por servicios</span>
                                    <span>${{total_servicios}}</span>
                                </div>
                                <div class="wt-space-block">
                                    <strong>Total</strong>
                                    <strong>${{propuesta.total}}</strong>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        methods: {
            ...
            getPropuesta() {
                ...
                .then(res => {
                    ...
                    this.espacio = this.propuesta.espacio;
                    this.getTotalServices();
                    this.getDias();
                });
            },
            getTotalServices() {
                this.propuesta.servicios.forEach((arr) => {
                    this.total_servicios = this.total_servicios + arr.simporte;
                });
            },
            enviarPropuesta() {},
            getDias() {
