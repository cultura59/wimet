...
@section('content')
	...
	<section class="container">
		<h1 class="wt-m-bot-4"><b>Mis solicitudes</b> de reserva</h1>
			...
			<table class="table table-striped">
				...
				<tr>
					...
					<td class="text-center">
						<a href="{{url('/dashboard/user/1/solicitud/1')}}" title="ver">
				...
				<tr>
					...
					<td class="text-center">Adrián Rojas</td>
					<td class="text-center">$13670</td>
					<td class="text-center"><span class="label label-success">Finalizada</span></td>
					<td class="text-center">
						<a href="{{url('/dashboard/user/1/solicitud/1')}}" title="ver">
							<i class="fa fa-external-link" aria-hidden="true"></i>
						</a>
