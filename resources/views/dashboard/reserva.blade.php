					...
					<div class="box-reserva" style="width: 95%">
						...
						<div class="box-reserva__body">
							...
							<div class="box-reserva_compartir wt-center-block">
								<input ng-click="reservar()" class="btn wt-btn-primary" value="Aceptar">
								<input ng-click="reservar()" class="btn wt-btn-primary" value="Cancelar">
							</div>
						</div>
					</div>
				</div>
