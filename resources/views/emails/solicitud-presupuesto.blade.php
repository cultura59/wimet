                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 13px;">
                                <a class="mcnButton " title="ENVIAR PRESUPUESTO" href="http://www.wimet.co/dashboard/user/{{$usuario->id}}/evento/{{$evento->id}}/nuevapropuesta" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">ENVIAR PRESUPUESTO</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
