...
<html lang="{{ config('app.locale', 'es') }}">
    ...
    <body class="page-publica">
        <!-- Header Home -->
        <header id="home-espacio" class="header-publica">
            <!-- navbar -->
            ...
            <div class="header-publica__main">
            	<h2>Publica tu espcio</h2>
				<h2>y conviértete en anfitrión</h2>
				<p>es gratis : )</p>
				<button-publica></button-publica>
            </div>
        </header>
        ...
        <main>
            ...
            <section class="summar-espacio">
            	...
            	<button class="btn-sumar-espacio">¡COMIENZA AHORA!</button>
            	<p class="wt-m-top-3">Si tienes alguna duda puedes consultar <span class="preguntas-freguentes">nuestras preguntas frecuentes</span></p>
            </section>
        </main>
